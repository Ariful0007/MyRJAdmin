...
public class AdapterSub extends RecyclerView.Adapter<AdapterSub.myview> {
    ...
    @NonNull
    @Override
    public AdapterSub.myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.subbb,parent,false);
        return new AdapterSub.myview(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterSub.myview holder, final int position) {
