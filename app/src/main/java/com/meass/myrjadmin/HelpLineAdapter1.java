...
public class HelpLineAdapter1  extends RecyclerView.Adapter<HelpLineAdapter1.myview> {
    ...
    @NonNull
    @Override
    public HelpLineAdapter1.myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.calling,parent,false);
        return new HelpLineAdapter1.myview(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HelpLineAdapter1.myview holder, final int position) {
