...
public class AdminListActivity extends AppCompatActivity {
    ...
    HelpLineAdapter1 getDataAdapter1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getDataAdapter1 = new HelpLineAdapter1(getList);
        firebaseFirestore = FirebaseFirestore.getInstance();
        documentReference = firebaseFirestore.collection("AdminAccess").document();
        recyclerView = findViewById(R.id.rreeeed);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(AdminListActivity.this));
