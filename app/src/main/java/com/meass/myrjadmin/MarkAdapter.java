...
public class MarkAdapter  extends RecyclerView.Adapter<MarkAdapter.myView> {
    ...
    @NonNull
    @Override
    public MarkAdapter.myView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.block, parent, false);
        return new MarkAdapter.myView(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MarkAdapter.myView holder, final int position) {
