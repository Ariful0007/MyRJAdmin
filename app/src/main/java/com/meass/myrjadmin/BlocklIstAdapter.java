...
public class BlocklIstAdapter extends RecyclerView.Adapter<BlocklIstAdapter.myView> {
    ...
    @NonNull
    @Override
    public BlocklIstAdapter.myView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.block, parent, false);
        return new BlocklIstAdapter.myView(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BlocklIstAdapter.myView holder, final int position) {
