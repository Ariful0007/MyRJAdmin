...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.myView> {
    ...
    @NonNull
    @Override
    public ChatAdapter.myView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.chatbox, parent, false);
        return new ChatAdapter.myView(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ChatAdapter.myView holder, final int position) {
