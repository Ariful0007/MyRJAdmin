...
public class ReferList2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_refer_list2);
        ...
        documentReference  =      firebaseFirestore.collection(daily)
                ...
                .collection("Months")
                .document(""+year)
                .collection(""+month).document();
        recyclerView =findViewById(R.id.rreeeed);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(ReferList2.this));
    ...
    private void reciveData() {
        ...
        firebaseFirestore.collection(daily)
                ...
                .collection("Months")
                .document(""+year)
                .collection(""+month).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
