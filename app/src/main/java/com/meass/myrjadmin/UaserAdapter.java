...
public class UaserAdapter extends RecyclerView.Adapter<UaserAdapter.myview> {
    ...
    @NonNull
    @Override
    public UaserAdapter.myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.payment2,parent,false);
        return new UaserAdapter.myview(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UaserAdapter.myview holder, final int position) {
